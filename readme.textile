...
In this directory you can find patched versions of "WYSIWYG":https://www.mediawiki.org/wiki/Extension:WYSIWYG and "WikiEditor":http://www.mediawiki.org/wiki/Extension:WikiEditor MediaWiki 1.20 extensions. This allows to use CKEditor for editing the wiki articles.

WYSIWYG extension allows to integrate the visual editor CKEditor in MediaWiki:http://ckeditor.com/demo in MediaWiki.
...
* Add/Replace the five files told by "DheerajKumarBit":http://www.mediawiki.org/wiki/Extension_talk:WYSIWYG#Patch_for_MW_1.19_12780 with the patches to make it work in MediaWiki 1.20 version
* Modify some of the JavaScript code for integrate WYSIWYG and WikiEditor 

The modifications of Javascript code have been done in the files and for
